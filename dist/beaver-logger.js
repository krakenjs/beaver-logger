!function(root, factory) {
    ...
    return function(modules) {
        ...
        function esm_utils_getActualProtocol(win) {
            void 0 === win && (win = window);
            return win.location.protocol;
        }
        function esm_utils_getProtocol(win) {
            void 0 === win && (win = window);
            if (win.mockDomain) {
                var protocol = win.mockDomain.split("//")[0];
                if (protocol) return protocol;
            }
            return esm_utils_getActualProtocol(win);
        }
        function esm_utils_isAboutProtocol(win) {
            void 0 === win && (win = window);
            return "about:" === esm_utils_getProtocol(win);
        }
        function esm_utils_canReadFromWindow(win) {
            try {
                return !0;
            } catch (err) {}
            return !1;
        }
        function esm_utils_getActualDomain(win) {
            void 0 === win && (win = window);
            var location = win.location;
            if (!location) throw new Error("Can not read window location");
            var protocol = esm_utils_getActualProtocol(win);
            if (!protocol) throw new Error("Can not read window protocol");
            if ("file:" === protocol) return "file://";
            if ("about:" === protocol) {
                var parent = function(win) {
                ...
                return parent && esm_utils_canReadFromWindow() ? esm_utils_getActualDomain(parent) : "about://";
            }
            var host = location.host;
            if (!host) throw new Error("Can not read window host");
            return protocol + "//" + host;
        }
        function esm_utils_getDomain(win) {
            void 0 === win && (win = window);
            var domain = esm_utils_getActualDomain(win);
            return domain && win.mockDomain && 0 === win.mockDomain.indexOf("mock:") ? win.mockDomain : domain;
        }
        function esm_utils_isSameDomain(win) {
            if (!function(win) {
                try {
                    if (win === window) return !0;
                } catch (err) {}
                ...
                try {
                    if (esm_utils_isAboutProtocol(win) && esm_utils_canReadFromWindow()) return !0;
                } catch (err) {}
                try {
                    if (function(win) {
                        void 0 === win && (win = window);
                        return "mock:" === esm_utils_getProtocol(win);
                    }(win) && esm_utils_canReadFromWindow()) return !0;
                } catch (err) {}
                try {
                    if (esm_utils_getActualDomain(win) === esm_utils_getActualDomain(window)) return !0;
                } catch (err) {}
                return !1;
            }(win)) return !1;
            try {
                if (win === window) return !0;
                if (esm_utils_isAboutProtocol(win) && esm_utils_canReadFromWindow()) return !0;
                if (esm_utils_getDomain(window) === esm_utils_getDomain(win)) return !0;
            } catch (err) {}
            return !1;
        }
        function getHTTPTransport(httpWin) {
            void 0 === httpWin && (httpWin = window);
            var win = esm_utils_isSameDomain(httpWin) ? function(win) {
                if (!esm_utils_isSameDomain(win)) throw new Error("Expected window to be same domain");
                return win;
            }(httpWin) : window;
        ...
        function Logger(_ref) {
            ...
            function print(level, event, payload) {
                if (Object(belter.isBrowser)() && window.console && window.console.log && !(LOG_LEVEL_PRIORITY.indexOf(level) > LOG_LEVEL_PRIORITY.indexOf(logLevel))) {
                    var args = [ event ];
                    args.push(payload);
            ...
            function immediateFlush() {
                return zalgo_promise.ZalgoPromise.try((function() {
                    if (Object(belter.isBrowser)() && window.location.protocol !== PROTOCOL.FILE && (events.length || tracking.length)) {
                        var meta = {};
                        ...
                        events = [];
                        tracking = [];
                        return zalgo_promise.ZalgoPromise.resolve(res).then(belter.noop);
                    }
                }));
            }
            var flush = Object(belter.promiseDebounce)(immediateFlush);
            var logger = {
                ...
                track: function(payload) {
                    void 0 === payload && (payload = {});
                    if (!Object(belter.isBrowser)()) return logger;
                    var trackingPayload = Object(belter.objFilter)(payload);
            ...
            function log(level, event, payload) {
                ...
                var logPayload = _extends({}, Object(belter.objFilter)(payload), {
            ...
            Object(belter.isBrowser)() && Object(belter.safeInterval)(flush, flushInterval);
